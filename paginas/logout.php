<?php
    session_start();
    session_destroy(); // destroimos a sessão para fazer o logout
?>
...
<body>
    <main>
        <div id='div1'>
            <img src="../imagens/logout.jpg" alt='Até breve!' id='img1'>
            <em><h1><span>A</span>té breve<span>!</span></h1></em>
        </div>
        <div id='div2'>
            <h2>Mas não se preocupe vamos redirecionar você!</h2>
            <h3>Caso deseje. Faça login novamente!</h3>
