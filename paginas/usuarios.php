...
class Usuario{
    ...
    // CADASTRO
    public function cadastrarUsuario($nome, $data, $cpf, $nomeMae, $sexo, $email, $telefone, $telefoneFixo, $endereco, $complemento, $login, $senha){
        ...
        if($cmd->rowCount() > 0){
            ...
            // e por fim fazemos a inserção dos dados
            $cmd = $this->pdo->prepare("INSERT INTO cad_usuarios (nome, data, cpf, nomeMae, sexo, email, telefone, telefoneFixo, endereco, complemento, login, senha) VALUES (:n, :d, :c, :nm, :s, :e, :t, :tf, :end, :comp, :l, :sen)");
